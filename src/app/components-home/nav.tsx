...
export default function Nav() {
    const [activeSection, setActiveSection] =
        useState<string>("form-mechanical");
            ...
            <div className="nav__container">
                <button
                    className={`nav__mech nav__element ${
                        activeSection === "form-mechanical" ? "active" : ""
                    }`}
                    onClick={() => handleNavClick("form-mechanical")}
                ...
                <button
                    className={`nav__elec nav__element ${
                        activeSection === "form-electrical" ? "active" : ""
                    }`}
                    onClick={() => handleNavClick("form-electrical")}
                    style={{ cursor: "pointer" }}
                >
                    <div className="nav__svg-container">
                ...
                <button
                    className={`nav__cosm nav__element ${
                        activeSection === "form-physical" ? "active" : ""
                    }`}
                    onClick={() => handleNavClick("form-physical")}
                    style={{ cursor: "pointer" }}
                >
                    <div className="nav__svg-container">
